    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">System Notifications</h1>
                ...
                <CardContent className="p-0">
                    {loading ? (
                        ...
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-lg font-medium text-slate-900">No activities recorded</h3>
                            ...
                            {notifications.map((notif) => (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        !notif.read_at ? "bg-teal-50/20 border-teal-500" : "bg-white border-transparent hover:bg-slate-50/50"
                                    )}
                                >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-4 mb-1">
                                                <p className={cn(
                                                    ...
                                                    !notif.read_at ? "font-semibold text-slate-900" : "text-slate-600"
                                                )}>
                                                    {notif.message}
                                                </p>
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className={cn(
                                                    ...
                                                    notif.type === 'success' ? "text-green-600 bg-green-50" :
                                                        notif.type === 'warning' ? "text-amber-600 bg-amber-50" :
