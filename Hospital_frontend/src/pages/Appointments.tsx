...
import { Search, Calendar as CalendarIcon, Clock, User, FileText, Plus, X, RefreshCw, Edit, CheckCircle2, XCircle, LayoutPanelLeft } from 'lucide-react';
...
const Appointments = () => {
    ...
    const getStatusStyle = (status: string) => {
        switch (status) {
            case 'prevu': return 'bg-blue-50 text-blue-700 border-blue-200';
            case 'confirme': return 'bg-teal-50 text-teal-700 border-teal-200';
            case 'en_cours': return 'bg-amber-50 text-amber-700 border-amber-200';
            case 'effectue': return 'bg-indigo-50 text-indigo-700 border-indigo-200';
    ...
    const getIconStyle = (status: string) => {
        switch (status) {
            case 'prevu': return 'bg-blue-100 text-blue-600';
            case 'confirme': return 'bg-teal-100 text-teal-600';
            case 'en_cours': return 'bg-amber-100 text-amber-600';
            case 'effectue': return 'bg-indigo-100 text-indigo-600';
            ...
            >
                <form onSubmit={handleBook} className="space-y-4">
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-700">Sélection du Patient</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-700">Personnel Médical</label>
                        <select
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-slate-700">Date & Heure</label>
                            <Input
                                type="datetime-local"
                                required
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-700">Motif de la visite</label>
                        <Input
                            required
